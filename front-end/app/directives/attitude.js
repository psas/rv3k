        ...
        link: function($scope, elem, attrs) {
            ...
            function allThis(){
                ...
                function init() {
                    ...
                    renderer.setSize(window.innerWidth / 4, 400);
                    elem[0].appendChild(renderer.domElement);

                    // Activates resize of attitude on window resize
                ...
                function onWindowResize(event) {
                    // This is where the size of the Attitude window is resized
                    // setSize(int, int, optional boolean); Previously set to window.innerWidth / 2, window.innerHeight / 2
                    renderer.setSize(window.innerWidth / 4, 400);
                }
